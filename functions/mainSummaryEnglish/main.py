...
def lambda_handler(event, context):
    ...
    try:
        ...
        transcript_text = response['Item']['transcript_formatted']  # Assuming this is the correct key
        ...
        summary_en = response['content'][0]['text']  # Check if this matches the actual response structure
        ...
        return {
            'statusCode': 200,
            's3_uri': s3_uri,
            'body': json.dumps({'summary': summary_en}, ensure_ascii=False)
        }
